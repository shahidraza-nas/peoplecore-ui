    ...
    return (
        <div className="max-w-3xl mx-auto py-10 px-4">
            ...
            <ul className="space-y-8">
                {newsfeeds.map((item) => (
                    <li key={item.id} className={`relative border rounded-xl p-6 shadow-lg transition hover:shadow-xl ${item.pinned ? 'border-yellow-400 bg-yellow-50 dark:border-yellow-500 dark:bg-zinc-900' : 'border-zinc-100 bg-white dark:border-zinc-800 dark:bg-zinc-900'}`}>
                        {item.pinned && (
